...
public class Bonder3
{
    ...
    {
        if (this.retrieveAtom(false).Type == AtomType.TEXT)
            return new ExplicitText(){Text = this.retrieveAtom(true).Value}; // .Trim('"')
